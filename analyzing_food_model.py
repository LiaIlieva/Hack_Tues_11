...
def evaluate_food(goal, product_info):
    goal = goal
    calories = product_info['nutritional_info']['calories']
    fat = product_info['nutritional_info']['fat']
    protein = product_info['nutritional_info']['protein']
    sugar = product_info['nutritional_info']['sugar']
...
def analyze_ingredients(ingredients):
    ...
    result = ingredient_classifier(ingredients, candidate_labels=unhealthy_labels)
